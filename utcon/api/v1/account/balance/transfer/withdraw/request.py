...
@router.post("/request")
async def request_withdraw(req: BalanceRequest):
    ...
    async with db.connection() as conn:
        async with conn.transaction():
            current_balance = await balance_repo.get_balance_for_update(conn, req.discord_uuid)
            ...
            queue_row = await conn.fetchrow(
                ...
                VALUES ($1, $2, 'pending', NOW(), NULL, NULL, NULL, NULL)
